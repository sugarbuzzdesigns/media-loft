		...
		array(
			...
			'slides' => array(
					array(
						...
						'media'=> array('video','Target_loop_01.mp4','Target_01.mp4', 'Target_Poster_Mobile.jpg')
					)
				),
			'related' => array(
					array(
		...
		array(
			...
			'slides' => array(
					array(
						...
						'media'=> array('video','RZR_loop_01.mp4','RZR_01.mp4', 'RZR_Poster-Mobile.jpg')
					),
					array(
						'label'=>'XP 1000 Luanch Video',
						'description'=> "<p>RZR's next-generation XP 1000 was developed to set a new standard for off-road performance and bring added momentum to the industry's best-selling brand. To unveil this groundbreaking machine with all the fanfare it deserved,</p><p>RZR wanted an unforgettable launch video. Media Loft delivered a nine-minute epic shot across three states and capturing the machine from every angle with gyro-stabilized Alexa cameras, chase helicopters, an Ultimate</p><p>Arm crane and POV camera mounts. Aerial camera crew and voice talent came from Los Angeles and the far-flung graphics team included some of Detroit's best automotive animators.</p>",
		...
		array(
			...
			'slides' => array(
					array(
						...
						'media'=> array('video','Mayo_loop_01.mp4','Mayo_01.mp4', 'Mayo_Poster_Mobile.jpg')
					)
				),
			'related' => array(
					array(
		...
		array(
			...
			'slides' => array(
					array(
						...
						'media'=> array('video','Indian_loop_01.mp4','Indian_01.mp4', 'Indian_Poster_mobile.jpg')
					),				
					array(
						'label'=>'Press Event',
						'description'=> "<p>The legendary, annual motorcycle rally in Sturgis, South Dakota, served as the backdrop for reintroducing one of the most iconic motorcycles ever made – Indian Scout. The VIP launch event used a combination of</p><p>high-end video fromion and old-school carnival attraction to capture the attention and accolades of 150 influential members of the press. Megastar Mark Wahlberg and American Picker Mike Wolfe added a layer of celebrity</p><p>buzz and helped narrate the video compilation that bought the story to consumers online.</p>",
		...
		array(
			...
			'slides' => array(
					array(
						...
						'media'=> array('video','Dell_loop_01.mp4','Dell_01.mp4', 'Dell_Poster_Mobile.jpg')
					),
					array(
						'label'=>'Global Sales Meeting Staging',
						'description'=> "Held in Las Vegas, Singapore and Copenhagen, Dell's Field Readiness Seminars aligned 10,500 members of Dell's global sales organization. For the fifth year in a row, Media Loft conceived and executed high-impact live elements plus video and motion graphics to unlock the power of Dell's strategic playbook.",
		...
		array(
			...
			'slides' => array(
					array(
						...
						'media'=> array('video','United_loop_01.mp4','United_01.mp4', 'Essen_Poster_Mobile.jpg')
					),				
					array(
						'label'=>'Customer Sales Event Staging',
						'description'=> "A 285-ft. widescreen at the Gaylord Opryland Nashville was the ideal backdrop to announce the big news: that the multiple companies brought together for this meeting were officially merging and rebranding under one name and identity. Media Loft created the meeting theme, screen graphics, registration website graphics and extensive onsite signage.",
		...
		array(
			...
			'slides' => array(
					array(
						...
						'media'=> array('video','Polaris_loop_1.mp4','Polaris_01.mp4', 'Polaris_Poster_Mobile.jpg')
					),
					array(
						'label'=>'Sales Event Staging',
						'description'=> "For almost four decades Media Loft has been producing Sales Meetings for Polaris. These bi-annual events are an essential tool for launching new products, unveiling new retail initiatives and stoking dealer pride. The 60th Anniversary gathering featured a 5,000-seat theater that hosted over 20 new product introductions, a hall of fame induction ceremony, and headline concerts by Big & Rich and Zac Brown Band.  When not in the theater, dealers got first-hand experience with all the new products through small group walk-arounds, a 150,000 sq. ft. display area and a custom-made demo track. ",
		...
		array(
			...
			'slides' => array(
					array(
						...
						'media'=> array('video','Optum_loop_01.mp4','Optum_01.mp4', 'Optum_Poster_Mobile.jpg')
					)
				),
			'related' => array(
		...
		array(
			...
			'slides' => array(
					array(
						...
						'media'=> array('video','Motion_GFX_Loop_01.mp4','Motion_GFX_01.mp4', 'Motion_Poster_Mobile.png')
					)
				),
			'related' => array(
					array(
		...
		array(
			...
			'slides' => array(
					array(
						...
						'media'=> array('video','Staples_loop_01.mp4','Staples_01.mp4', 'Staples_Poster_Mobile.jpg')
					)
				),
			'related' => array(
					array(
		...
		array(
			...
			'slides' => array(
					array(
						...
						'media'=> array('video','Show_GFX_Loop_01.mp4','Show_GFX_01.mp4', 'Show_Poster_Mobile.jpg')
					)
				),
			'related' => array(				
