	...
	$workItems = array(
		array(
			...
			'slides' => array(
					array(
						'label'=>'Online Diversity Campaign Videos',
						'description'=> '<p>For this series of videos highlighting the diversity of Target team around the US, we had to work fast. So we sent video crews to three cities simultaneously where they captured 35 interviews in</p><p>just two days. With around-the-clock editing and an elegant, original music score, in just seven days we delivered a campaign of, in the words of our client, "flawless, goose bump-inducing" videos.</p>',
		...
		array(
			...
			'slides' => array(
					array(
						'label'=>'Simulcast Event Interactive',
						'description'=> "<p>To make their annual employee appreciation day especially eventful, Media Loft helped produce a live online simulcast available to all 80,000 Optum employees across the globe. Optum executives served as show co-hosts </p><p>in a \"Today Show\"-style broadcast that included pre-taped video roll-ins, executive interviews and employees celebrating in Australia, India, England and the Philippines.</p>",
