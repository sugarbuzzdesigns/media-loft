	...
	ml.Services = {
		init: function(){
			...
			var slider = $('.bxslider').bxSlider({
				pagerType: 'short',
				pagerSelector: '.pager-numbers',
				onSliderLoad: function(){
					// $('.bx-viewport').height($('.quote:first').height());	
				},
				onSlideBefore: function($slideElement, oldIndex, newIndex){
					// $('.bx-viewport').height($slideElement.height());
				}
			});
		...
		showPrevQuote: function(){
			...
			if($showing.is('.first')){
				...
				$('blockquote').height($('blockquote .quote.last').height());
		...
		showNextQuote: function(){
			...
			if($showing.is('.last')){
				$showing.removeClass('show');
				$('blockquote').height($('blockquote .quote.first').height());
